  ...
  <Header/>
    <div className="mx-auto max-w-7xl px-2 md:px-4">
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mx-auto max-w-7xl px-4">
  {/* Hero Map */}
  <div className="flex flex-col-reverse md:flex-row space-y-8 pb-10 pt-12 md:pt-24">
    <div className="md:w-1/2">
      {/* Image */}
      <img
        className="object-cover w-full h-64 rounded-md md:h-auto"
        src="your-image-url.jpg"
        alt="Vintage IT Academy"
      />
    </div>
    <div className="md:w-1/2">
      <div className="max-w-max rounded-full border bg-gray-50 p-1 px-3">
        <p className="text-xs font-semibold leading-normal md:text-sm">
          About the Vintage IT Academy
        </p>
      </div>
      <p className="text-3xl font-bold text-gray-900 md:text-3xl md:leading-10">
        Driven by an unwavering commitment to contribute to society.
      </p>
      <p className="max-w-4xl text-base text-gray-600 md:text-lg">
      Established in 2010 by Mr. Priyam Shekhar Kaushik, Vintage IT Academy began as a master franchise of VAIMS, later becoming an independent computer institute under the SR Act 1860. Driven by a commitment to society, Mr. Kaushik, a first-class engineering graduate, aimed to provide quality IT education to the northern bank of Assam. Starting with four computers, he laid the foundation for the institute, which quickly became a benchmark in Sonitpur district and across Assam. Despite challenges, the institute has successfully shaped the careers of thousands of students, offering high-quality education.
